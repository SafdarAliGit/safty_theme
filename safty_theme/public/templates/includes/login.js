...
//     $('.forgot-password-message a').click(function() {
// 		$('.forget-bg').toggleClass('hidden')
//     $('.forget-bg').toggleClass('hidden')
//   });
...
login.login = function () {
	$('.background-login').removeClass('hidden')
    $('.background-forget').addClass('hidden')
...
login.forgot = function () {
	...
	$('.background-login').addClass('hidden')
    $('.background-forget').removeClass('hidden')
